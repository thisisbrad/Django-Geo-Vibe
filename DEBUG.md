...
- [Running the Application](#running-the-application)
  - [3. Start Backend Server](#3-start-backend-server)
  - [4. Start Frontend Server](#4-start-frontend-server)
  - [5. Run Bus Movement Simulation](#5-run-bus-movement-simulation)
...
2. Navigate to the frontend URL (typically `http://localhost:5173` or `http://localhost:5174`)
3. You should see the interactive map with bus markers
4. As the simulation runs, you'll see buses moving in real-time on the map
...
Enjoy tracking buses in real-time! 🚌🗺️
